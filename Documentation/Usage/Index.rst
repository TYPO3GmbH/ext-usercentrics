...
The foundation of the Usercentrics for TYPO3 Integration is the TYPO3's `Asset Collector`_. To support TYPO3 versions
prior to 10.3, the Asset Collector has been backported into this extension.
...
.. code-block:: php
   ...
   $dataServiceProcessor = 'Google Analytics';
   $assetCollector = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance(\T3G\AgencyPack\Usercentrics\Page\AssetCollector::class);
